<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="诗词名称" prop="shicimingcheng">
          <el-input v-model="ruleForm.shicimingcheng" 
              placeholder="诗词名称" clearable  :readonly="ro.shicimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="诗词名称" prop="shicimingcheng">
              <el-input v-model="ruleForm.shicimingcheng" 
                placeholder="诗词名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="诗词分类" prop="shicifenlei">
          <el-select v-model="ruleForm.shicifenlei" placeholder="请选择诗词分类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="诗词分类" prop="shicifenlei">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="译文" prop="yiwen">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.yiwen" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yiwen" label="译文" prop="yiwen">
                    <span v-html="ruleForm.yiwen"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="注释" prop="zhushi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zhushi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhushi" label="注释" prop="zhushi">
                    <span v-html="ruleForm.zhushi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="赏析" prop="shangxi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.shangxi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shangxi" label="赏析" prop="shangxi">
                    <span v-html="ruleForm.shangxi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yiwen = true;
          ...
          if(o=='zhushi'){
            this.ruleForm.zhushi = obj[o];
	    this.ro.zhushi = true;
            continue;
          }
          if(o=='shangxi'){
            this.ruleForm.shangxi = obj[o];
	    this.ro.shangxi = true;
            continue;
          }
          if(o=='thumbsupnum'){
	...
	this.ruleForm.yiwen = this.ruleForm.yiwen.replace(reg,'../../../ssm04609/upload');
	this.ruleForm.zhushi = this.ruleForm.zhushi.replace(reg,'../../../ssm04609/upload');
	this.ruleForm.shangxi = this.ruleForm.shangxi.replace(reg,'../../../ssm04609/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shicishangxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shicishangxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
